  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="mb-8">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="mt-2 text-gray-500">
            Manage and review teacher applications | Last updated: {formatDateTime(new Date().toISOString())}
          </p>
        </div>
        <div className="flex items-center space-x-4">
          ...
          <select className="pl-4 pr-10 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white appearance-none">
      ...
      <div className="grid grid-cols-4 gap-4 mt-6">
        {[
          { label: 'Total Requests', value: teacherRequests.length, color: 'blue' },
          { label: 'Pending', value: teacherRequests.filter(t => t.status === 'pending').length, color: 'yellow' },
          { label: 'Approved', value: teacherRequests.filter(t => t.status === 'approved').length, color: 'green' },
          { label: 'Rejected', value: teacherRequests.filter(t => t.status === 'rejected').length, color: 'red' }
        ].map((stat, index) => (
          ...
          <tbody className="divide-y divide-gray-200">
            {teacherRequests.map((teacher) => (
              <tr key={teacher.id} className="hover:bg-gray-50 transition-colors duration-150">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <div className="h-12 w-12 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 p-0.5">
                    ...
                    <div className="ml-4">
                      ...
                      <div className="text-xs text-gray-500 flex items-center mt-1">
                        ...
                        Applied on {formatDateTime(teacher.date)}
                      </div>
                    </div>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <div className="text-xs text-gray-500">Verified Email</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-gray-900">{teacher.experience}</span>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className={`
                    ...
                    ${
                      teacher.status === 'pending' ? 'bg-yellow-50 text-yellow-700 ring-1 ring-yellow-600/20' :
                      teacher.status === 'approved' ? 'bg-green-50 text-green-700 ring-1 ring-green-600/20' :
                  ...
                  `}>
                    <span className={`
                      ...
                      ${
                        teacher.status === 'pending' ? 'bg-yellow-600' :
                        teacher.status === 'approved' ? 'bg-green-600' :
                        'bg-red-600'
                      }
                    `} />
                  ...
                  {teacher.status === 'pending' ? (
                    <div className="flex space-x-2">
                      <button
                        ...
                        className="px-3 py-1 rounded-lg bg-green-50 text-green-700 hover:bg-green-100 transition-colors duration-150 flex items-center"
                      >
                      ...
                      <button
                        ...
                        className="px-3 py-1 rounded-lg bg-red-50 text-red-700 hover:bg-red-100 transition-colors duration-150 flex items-center"
                      >
                        <svg className="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <span className="text-sm text-gray-700">
              ...
              <span className="font-medium">{teacherRequests.length}</span> results
            </span>
          </div>
          <div className="flex items-center space-x-2">
...
{activeTab === 'completed' && (
  <div>
    <div className="flex justify-between items-center mb-6">
      <h2 className="text-3xl font-bold">Completed Requests</h2>
      <div className="flex items-center space-x-4">
        <select className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
